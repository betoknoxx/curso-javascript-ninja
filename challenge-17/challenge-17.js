(function() {
    ...
    */
    ...
    console.log( text.replace( /Manuel Marques de Sousa/, 'Roberto Eustáquio Belem Junior' ) );
    ...
    */
    ...
    console.log( text.replace( /brasileiro/, 'sete lagoano' ) );
    ...
    */
    ...
    console.log( text.replace( /O Centauro de Luvas/g, function(selText) {
        return selText.toLocaleUpperCase();
    }));
